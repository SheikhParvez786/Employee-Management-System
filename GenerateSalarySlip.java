...
public class GenerateSalarySlip extends JFrame implements ActionListener{
    ...
    GenerateSalarySlip() {
        ...
        JLabel heading = new JLabel("Generate Salary Slip Detail");
        heading.setBounds(350, 10, 700, 50);
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == search) {
            String query = "select * from Salary where empId = '"+cemployeeId.getSelectedItem()+"'";
            try {
                Conn c = new Conn();
